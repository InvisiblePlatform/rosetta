...
def mbfcGetData():
    ...
    data = load_data_from_file("combined.json")
    ...
    for source in reversed(data["sources"]):
        ...
        if is_file_modified_over_a_week_ago("./html_cache/" + stub + ".html"):
    ...
    save_data_to_file(index, "mbfc-index.json")
                    ...
                    if available_ratings.get(domain.replace("www.", "")):
                        ...
                        pprint(
                            [
                                domain,
                                slug,
                                available_ratings.get(domain.replace("www.", "")),
                            ]
                        )
                    else:
